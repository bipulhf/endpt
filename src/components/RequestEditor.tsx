...
export const RequestEditor = ({
  ...
  return (
    <section className="flex min-h-0 min-w-0 flex-1 flex-col overflow-y-auto overflow-x-hidden p-2.5 sm:p-2 lg:p-2">
      <RequestTabs
      ...
      <div className="panel-surface mb-2.5 rounded-[1rem] p-2.5 sm:mb-3 sm:rounded-[1.25rem] sm:p-2">
      ...
      {(() => {
        ...
        return (
          <div className="mb-2.5 flex flex-wrap gap-1 rounded-[0.95rem] border border-border/70 bg-background/40 p-1">
            {(
              [
          ...
          {(activeRequest.body.type === "json" ||
            ...
            <>
              ...
              <textarea
                ...
                className="control-field min-h-[220px] w-full resize-y rounded-[1rem] p-2.5 font-mono text-sm text-foreground"
              />
            </>
          )}
          ...
          {activeRequest.body.type === "graphql" && (
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="control-field min-h-[150px] w-full resize-y rounded-[1rem] p-2.5 font-mono text-sm text-foreground"
              />
              <label className="text-xs uppercase tracking-[0.18em] text-muted-foreground">
                Variables (JSON)
              </label>
              <textarea
                ...
                className="control-field min-h-[110px] w-full resize-y rounded-[1rem] p-2.5 font-mono text-sm text-foreground"
              />
            </div>
          )}
        </div>
